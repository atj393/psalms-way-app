...
const PENDING_TRANSLATION = new Set([
  ...
  'psalmUnavailable',
  // Cloud Backup UI, added with the feature; awaiting translation.
  'backupSection',
  'backupTitle',
  'backupOptionalDesc',
  'backupUnavailable',
  ...
  'backupRestore',
  'backupDisconnect',
  'backupDisconnectBody',
  'backupDone',
  'backupRestoreConfirmTitle',
  'backupRestoreConfirmBody',
  'backupRestoreDone',
  'backupErrNotConfigured',
  'backupErrNotSignedIn',
  'backupErrAuthExpired',
  'backupErrNetwork',
  'backupErrQuota',
  'backupErrServer',
  'backupErrNoBackup',
  'backupErrCorrupt',
  'backupErrIncompatible',
  'backupErrRestoreFailed',
  'backupErrUnknown',
]);
